...
.cheat:hover {
    ...
    GUI.style.background = 'hsl(237, 87%, 37%)';
    ...
    header.innerHTML = `Blooket Cheats <span style="font-size: 0.75rem"></span>`;
    ...
    footer.innerHTML = (`<span>GUI by Clubby#8837<br>Cheats by <a style="color: lightblue" href="https://github.com/GitClubby">Clubby</a></span>`);
